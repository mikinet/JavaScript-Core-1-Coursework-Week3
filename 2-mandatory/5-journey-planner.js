...
/*
  ...
  To go to Tower Bridge, you can use tube or river boat. This information will be represented as 
...
*/
function isAccessibleByTransportMode(modesAvailable, preferredMode) {
  return modesAvailable.includes(preferredMode);
}
...
function journeyPlanner(locations, transportMode) {
  ...
  let availableOptions = locations.filter(location => location.slice(1).includes(transportMode));
  return availableOptions.map(location => location[0]);
}
